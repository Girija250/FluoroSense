...
async def read_users_me(current_user: Annotated[dict, Depends(auth.get_current_user)]):
    return schemas.UserResponse(
        ...
        resident_city=current_user.get("resident_city"),
        sibling_fluorosis_history=current_user.get("sibling_fluorosis_history"),
        neighbor_fluorosis_history=current_user.get("neighbor_fluorosis_history"),
    )
